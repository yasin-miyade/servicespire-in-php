...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 font-inter">
    ...
    <div class="max-w-6xl mx-auto p-8">
        ...
        <div class="grid grid-cols-1 gap-8">
            ...
            <div
                class="relative bg-white shadow-lg border-l-8 border-purple-500 rounded-xl overflow-hidden transform hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
                <div class="p-8">
                    <!-- Post Title -->
                    ...
                    <div class="mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <span class="text-gray-700 text-sm flex items-center gap-2">
                            <i class="ph ph-clock text-purple-600"></i> Posted on:
                            <?php echo date("d M Y", strtotime($post['created_at'])); ?>
                        </span>
                        <div class="flex items-center gap-4">
                            <a href="edit_post.php?id=<?php echo $post['id']; ?>"
                                class="bg-purple-600 text-white font-semibold py-2 px-5 rounded-lg hover:bg-purple-700 transition-all flex items-center gap-2">
                            ...
                            <form method="POST"
                                ...
                                <button type="submit"
                                    class="bg-red-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-red-700 transition-all flex items-center gap-2">
